				...
				<Table className={classes.table} aria-label="simple table">
					...
					{data.map((item, key) => (	
						<TableRow key={key}>
							...
							<TableCell align="center">{'R$ '+item.birth}</TableCell>
                            <TableCell align="center">{'R$ '+item.typePerson}</TableCell>
                            <TableCell align="center">{'R$ '+item.cpf}</TableCell>
                            <TableCell align="center">{'R$ '+item.companyId}</TableCell>				
						</TableRow>
						))}
					</TableBody>
				</Table>
